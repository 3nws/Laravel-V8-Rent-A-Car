            ...
            <div class="col-lg-8 ml-auto">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-unstyled">
                            @if($setting->facebook != null)<li><a href="{{ $setting->facebook }}" target="_blank"><i class="fab fa-facebook mr-1"></i>Facebook</a></li>@endif
                            @if($setting->instagram != null)<li><a href="{{ $setting->instagram }}" target="_blank"><i class="fab fa-instagram mr-2"></i>Instagram</a></li>@endif
